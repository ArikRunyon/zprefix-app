...
exports.seed = async function(knex) {
  ...
  await knex('inventory').insert([
    ...
    {user_id: '1', item_name: 'hook', description: 'no mission too impossible', quantity: '4'},
    {user_id: '2', item_name: 'talkie', description: 'Hans! Dont do it!', quantity: '1'},
    {user_id: '3', item_name: 'destiny', description: 'star? guitar pick? both!', quantity: '1'},
    {user_id: '3', item_name: 'over max', description: 'over 100 over 100 over 100 over 100 over 100 over 100 over 100 over 100 over 100 over 100 over 100 over 100 over 100 over 100 over 100 over 100 over 100 over 100 over 100 over 100 ', quantity: '1'},
  ]);
};
